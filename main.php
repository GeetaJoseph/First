	...
	<div class="row" >
		...
		<div class ="column">
			...
			<form class ="form-group" name = "employeeForm" action = "addEmployee.php" method = "get">
				...
				<p><input type="reset" value="CLEAR" />&nbsp; &nbsp;<input type="submit" name="Submit" value="CREATE" /></p>
				<p><input type="button" value="Open Tab" onclick="location.href=`helloWorld.php`;"/> </p>
				<p><a href="helloWorld.php" class="btn btn-info" role="button">Open New Tab</a></p>
